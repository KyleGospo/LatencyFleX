Name:       latencyflex-vulkan-layer-dev
...
# Don't allow this package to be used along-side the stable package.
Conflicts:  latencyflex-vulkan-layer
...
%prep
git clone --branch dev https://github.com/KyleGospo/LatencyFleX.git
cd LatencyFleX
